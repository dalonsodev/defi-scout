...
export function Layout() {
  ...
  return (
    <div className="site-wrapper mx-auto flex min-h-dvh max-w-5xl flex-col">
      <Navbar />
      ...
      <footer className="glass-surface w-full rounded-t-3xl border-t-(--border-subtle)">
        <div className="flex flex-col items-center justify-between px-6 pt-6 pb-4 md:flex-row">
          <Link
            to="/"
            className="mt-4 mb-6 rounded-full pl-0 transition-opacity hover:opacity-80 md:my-0 md:rounded-xl"
          >
            <img
