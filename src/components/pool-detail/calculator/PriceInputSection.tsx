...
interface PriceInputSectionProps {
  ...
  futureToken0PriceUSD: number
  futureToken1PriceUSD: number
  onToken0PriceChange: (value: number) => void
  onToken1PriceChange: (value: number) => void
}
 ...
 *
 * @param props
 * @param props.token0Symbol
 * @param props.token1Symbol
 * @param props.currentToken0PriceUSD - Current market price (API source)
 * @param props.currentToken1PriceUSD
 * @param props.futureToken0PriceUSD - User-projected price
 * @param props.futureToken1PriceUSD
 * @param props.onToken0PriceChange - Update handler for token0 projection
 * @param props.onToken1PriceChange - Update handler for token1 projection
 */
export function PriceInputSection({
  ...
  onToken0PriceChange,
  onToken1PriceChange
}: PriceInputSectionProps): ReactNode {
