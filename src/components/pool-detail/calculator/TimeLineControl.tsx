...
interface TimeLineControlProps {
  ...
  onDaysChange: (projectionDays: number) => void
}
 ...
 *
 * @param props
 * @param props.days - Current simulation duration (0-365)
 * @param props.onDaysChange - Dispatcher to trigger parent recalculation
 * @param props.daysToBreakEven - Days needed for fees ≥ IL (from useProjectionCalculator)
 * @returns Controlled input with increment/decrement buttons
 *
 * @example
