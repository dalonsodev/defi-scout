 ...
 * @property primary - Assumed price reference line color
 * @property secondary - Range boundary reference lines color
 * @property grid - Chart grid line color
 * @property axis - Axis label color
 * @property dataViz - Per-metric data colors
