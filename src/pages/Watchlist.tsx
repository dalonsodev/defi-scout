...
export default function Watchlist(): ReactNode {
  ...
  const paginatedPools = pools.slice((currentPage - 1) * PAGE_SIZE, currentPage * PAGE_SIZE)
  ...
  if (!pools.length) {
    return (
      <div className="text-base-content/50 flex flex-col items-center justify-center py-32">
        ...
        <p className="mt-1 text-sm">Star a pool from the main table to add it here.</p>
  ...
  return (
    <div className="p-4">
      ...
      <h1 className="text-base-content mb-6 text-2xl font-bold">My Watchlist</h1>
      <div className="glass-surface -mx-4 rounded-3xl shadow-lg sm:-mx-6 md:-mx-4">
        <PoolTable
          ref={tableScrollRef}
